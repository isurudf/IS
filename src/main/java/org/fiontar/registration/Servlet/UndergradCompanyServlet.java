...
public class UndergradCompanyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String companies="";
        for(int i=0;i<n;i++){
            if(request.getParameter("pref"+i)!=null&&!request.getParameter("pref"+i).equals("0"))
                companies+=request.getParameter("pref"+i)+",";
