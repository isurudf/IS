...
public class PasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (value2 != null) {
            ...
            try {
                ...
                if (oldPassword.equals(u.getPassword())) {
                    md.reset();
                    md.update(request.getParameter("newPassword").getBytes());
                    digest = md.digest();
                    ...
                    UndergradDA.updatePassword(id, newPassword);
                    cookie.setMaxAge(0);
                    response.addCookie(cookie);
                    response.sendRedirect("message.jsp?message="+ "Please log in now.");
                    return;
        ...
        } else if (request.getParameter("link") != null && request.getParameter("link").length() > 5) {
            ...
            try {
                ...
                UndergradDA.updatePassword(request.getParameter("link"), newPassword);
                response.sendRedirect("message.jsp?message="+ "Please log in now.");
                return;
