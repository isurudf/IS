...
(function ($, win, Modernizr) {
	...
	Ajax.include({
		initJS : function (url) {
			...
			break;
			case 'gallery-single.jsp':
				$(function () {
					modules.cycleSlider();
					modules.fancybox();
				});
			break;
			case 'gallery-single-alt.jsp':
				$(function () {
					modules.fancybox();
				});
			break;
		...
		epicslider : function () {
			if ($('.epicSlider').length) {
				$('.epicSlider').epicSlider({
					...
					easing : epicSlider.easing, 	//String: easing method - see http://jqueryui.com/demos/effect/easing.jsp
			...
			if($('.contact-form').length) {
				...
				$form.each(function() {
					...
					$this.submit(function() {
						...
						//send data to server
						$.post("php/contact-send.jsp", data, function(response) {
